...
export default function UserPage() {
  ...
  return (
    <div className="mt-10">
      <div className='flex justify-between items-center text-white mb-5 mt-10'>
        <h1 className="text-4xl font-bold mb-4">Abrigo {user?.name}</h1>
        <div className='flex gap-4 p-4 border border-white rounded-lg bg-white bg-opacity-80 backdrop-blur-lg shadow-lg hidden'>
          ...
          <div className="flex flex-col items-center text-red-700">
            ...
            <p className="text-4xl font-bold">{petsForAdoptionCount}</p>
          </div>
        </div>        
      </div>
      <div className='flex justify-between p-4 border border-white rounded-lg bg-white bg-opacity-80 backdrop-blur-lg shadow-lg relative'>
        <div className='text-gray-700'>          
          <p className='text-2xl mb-4'>Informações:</p>
          <p className='mb-2'>Responsável: {user?.responsable} </p>
        ...
        <div>
          <div className='text-gray-700'>
            <p className='text-2xl mb-4'>Doações que precisamos:</p>
            <div className='text-gray-700 mb-2'>
              <p>Em dinheiro via pix:</p>
              <p>{user?.document} </p>
            </div>
            ...
            <div>
              ...
              {user.donations.length > 5 && (
                <button onClick={togglePopover} className="bg-secundary text-white cursor-pointer border-none hover:bg-blue-500 mt-1">
                  Ver mais
                </button>
              )}
            </div>
        ...
        <div>
          <div className='text-gray-700'>
            <p className='text-2xl mb-4'>Horários</p>
      ...
      {/* Modal de doações */}
          {popoverOpen && (
            <div className='fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center '>
              <div ref={popoverRef} className="bg-white p-6 rounded-lg shadow-lg w-90">
              <ul className="space-y-2">
